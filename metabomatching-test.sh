...
metabomatching.sh -g -i "$PROG_DIR_NAME/test/ps.test.multi/test.pseudospectrum.tsv" -p "$PROG_DIR_NAME/test/parameters.gxy.1.tsv" -s "$scores_file" -S "$pdf_file" || exit 2
